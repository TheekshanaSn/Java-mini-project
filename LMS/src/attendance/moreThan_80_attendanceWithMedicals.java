...
public class moreThan_80_attendanceWithMedicals {
    ...
    public moreThan_80_attendanceWithMedicals() {
        frame = new JFrame();
        ...
        try {
            ...
            String Query = "SELECT at_undergraduate_id,at_course_code,(COUNT( attendance_id))/15*100 AS 'Attendance percentage'\n" +
                    ...
                    "HAVING ((COUNT( attendance_id))/15*100)>=80 ORDER BY at_undergraduate_id;";
