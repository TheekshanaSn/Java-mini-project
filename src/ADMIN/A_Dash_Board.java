...
public class A_Dash_Board extends JFrame {
    ...
    public A_Dash_Board() {
        ...
        Profile.setIcon(new javax.swing.ImageIcon(getClass().getClassLoader().getResource("./ADMIN/profile.png")));
        UserManage.setIcon(new javax.swing.ImageIcon(getClass().getClassLoader().getResource("./ADMIN/user.png")));
        Coursemanage.setIcon(new javax.swing.ImageIcon(getClass().getClassLoader().getResource("./ADMIN/course.png")));
        Noticemanage.setIcon(new javax.swing.ImageIcon(getClass().getClassLoader().getResource("./ADMIN/notice.png")));
        Timetablemanage.setIcon(new javax.swing.ImageIcon(getClass().getClassLoader().getResource("./ADMIN/timetable.png")));
